...
import { SiGithub, SiResearchgate, SiTwitter, SiUdemy } from 'react-icons/si';
    ...
    <div className="flex justify-start py-2 px-1 items-center">
      ...
      >
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex justify-start py-2 px-1 items-center transition duration-300 hover:text-gray-200"
        >
          {value}
        </a>
      </div>
        ...
        <div className="mx-3">
          <h5 className="card-title">
            {loading ? (
              ...
              <span className="text-base-content opacity-70">Contact Information</span>
            )}
          </h5>
        </div>
              ...
              {social?.portfolio && (
                <ListItem
                  ...
                  value={social.portfolio
                    ...
                    .replace('http://', '')}
                  link={
                    !social.portfolio.startsWith('http')
                      ? `http://${social.portfolio}`
                      : social.portfolio
                  }
                />
              )}
